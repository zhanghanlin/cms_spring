...
public final class MenuSqlMapper {
    ...
    public static final String GET_ALL = "select * from " + TABLE_NAME + " where status <> 2 order by LENGTH(code) , weight desc";
    ...
    public static final String GET_MAX_CODE_BY_PARENT_CODE = "select MAX(code) from " + TABLE_NAME + " where parent_code = ?";
}