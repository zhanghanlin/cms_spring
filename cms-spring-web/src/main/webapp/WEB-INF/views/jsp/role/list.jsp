								...
								<div class="box-header">
									...
									<div class="box-tools">
										<div class="input-group" style="width: 250px;">
											<a role="button" href="/role/toAdd" class="btn btn-default btn-sm pull-left" data-toggle="modal" data-target="#modal" style="margin-right: 10px;">新增</a>
											<input type="text" name="table_search" class="form-control input-sm pull-right" placeholder="Search" style="width: 150px;"/>
