...
public class HttpUtils {
    ...
    public static HttpClient getClient() {
        ...
        try {
            ...
            LOG.error("getClient Exception : {}", e.getMessage(), e);
        }
        return client;
    }
    ...
    public static String doGet(String url, Map<String, String> paramMap) {
        ...
        try {
            ...
            client = getClient();
            LOG.info("doGet url : {}", urlSb.toString());
            ...
            LOG.info("doGet HttpStatus Code : {}", statusCode);
            ...
            LOG.error("doGet HttpException : {}", e.getMessage(), e);
        } catch (IOException e) {
            LOG.error("doGet IOException : {}", e.getMessage(), e);
        } catch (Exception e) {
    ...
    public static String doPost(String url, Map<String, String> params) {
        ...
        try {
            ...
            LOG.info("doPost HttpStatus Code : {}", statusCode);
            if (statusCode == HttpStatus.SC_OK) {
            ...
            LOG.error("doPost HttpException : {}", e.getMessage(), e);
        } catch (IOException e) {
            LOG.error("doPost IOException : {}", e.getMessage(), e);
        } catch (Exception e) {
